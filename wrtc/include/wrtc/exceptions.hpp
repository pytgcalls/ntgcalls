...
class name : public wrtc::BaseRTCException { public: explicit name(std::string msg) : wrtc::BaseRTCException(std::move(msg)) {} };
...
class name final : public base { public: explicit name(std::string msg) : base(std::move(msg)) {} };
