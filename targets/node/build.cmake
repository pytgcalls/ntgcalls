...
if (WINDOWS AND MSVC)
    target_link_options(${NTG_LIB_NAME} PRIVATE /DELAYLOAD:NODE.EXE /FORCE:MULTIPLE /IGNORE:4006)
endif ()
...
set_target_properties(${NTG_LIB_NAME} PROPERTIES
    ...
    LIBRARY_OUTPUT_DIRECTORY_RELEASE "${NODE_PKG_DIR}"
    RUNTIME_OUTPUT_DIRECTORY_RELEASE "${NODE_PKG_DIR}"
    LIBRARY_OUTPUT_DIRECTORY_DEBUG "${NODE_PKG_DIR}"
    RUNTIME_OUTPUT_DIRECTORY_DEBUG "${NODE_PKG_DIR}"
)