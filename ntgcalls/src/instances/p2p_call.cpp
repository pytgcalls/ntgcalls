...
namespace ntgcalls {
    ...
    void P2PCall::connect(const std::vector<RTCServer>& servers, const std::vector<std::string>& versions, const bool p2pAllowed, const std::optional<std::string> &customParameters) {
