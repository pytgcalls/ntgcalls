...
namespace wrtc {
    ...
    private:
        ...
        static cricket::ContentInfo convertSingalingContentToContentInfo(const std::string &contentId, const MediaContent &content, webrtc::RtpTransceiverDirection direction);
