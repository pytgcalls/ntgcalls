...
typedef void (*ntg_upgrade_callback)(uintptr_t, int64_t, ntg_media_state_struct,
                                     void *);

typedef void (*ntg_connection_callback)(uintptr_t, int64_t,
                                        ntg_network_info_struct, void *);

typedef void (*ntg_signaling_callback)(uintptr_t, int64_t, uint8_t *, int,
                                       void *);

typedef void (*ntg_frame_callback)(uintptr_t, int64_t, ntg_stream_mode_enum,
                                   ntg_stream_device_enum, ntg_frame_struct *,
                                   int, void *);

typedef void (*ntg_remote_source_callback)(uintptr_t, int64_t,
                                           ntg_remote_source_struct, void *);
...
NTG_C_EXPORT int ntg_create_p2p(uintptr_t ptr, int64_t userId,
                                ntg_media_description_struct desc,
                                ntg_async_struct future);

NTG_C_EXPORT int ntg_init_presentation(uintptr_t ptr, int64_t chatId,
                                       char *buffer, int size,
                                       ntg_async_struct future);

NTG_C_EXPORT int ntg_stop_presentation(uintptr_t ptr, int64_t chatId,
                                       ntg_async_struct future);

NTG_C_EXPORT int ntg_add_incoming_video(uintptr_t ptr, int64_t chatId,
                                        char *endpoint,
                                        ntg_ssrc_group_struct *ssrcGroups,
                                        int size, uint32_t *buffer,
                                        ntg_async_struct future);

NTG_C_EXPORT int ntg_remove_incoming_video(uintptr_t ptr, int64_t chatId,
                                           char *endpoint,
                                           ntg_async_struct future);

NTG_C_EXPORT int ntg_init_exchange(uintptr_t ptr, int64_t userId,
                                   ntg_dh_config_struct *dhConfig,
                                   const uint8_t *g_a_hash, int sizeGAHash,
                                   uint8_t *buffer, int size,
                                   ntg_async_struct future);

NTG_C_EXPORT int ntg_exchange_keys(uintptr_t ptr, int64_t userId,
                                   const uint8_t *g_a_or_b, int sizeGAB,
                                   int64_t fingerprint,
                                   ntg_auth_params_struct *buffer,
                                   ntg_async_struct future);

NTG_C_EXPORT int ntg_skip_exchange(uintptr_t ptr, int64_t userId,
                                   const uint8_t *encryptionKey, int size,
                                   bool isOutgoing, ntg_async_struct future);

NTG_C_EXPORT int ntg_connect_p2p(uintptr_t ptr, int64_t userId,
                                 ntg_rtc_server_struct *servers,
                                 int serversSize, char **versions,
                                 int versionsSize, bool p2pAllowed,
                                 ntg_async_struct future);

NTG_C_EXPORT int ntg_send_signaling_data(uintptr_t ptr, int64_t userId,
                                         uint8_t *buffer, int size,
                                         ntg_async_struct future);

NTG_C_EXPORT int ntg_get_protocol(ntg_protocol_struct *buffer);

NTG_C_EXPORT int ntg_create(uintptr_t ptr, int64_t chatID,
                            ntg_media_description_struct desc, char *buffer,
                            int size, ntg_async_struct future);

NTG_C_EXPORT int ntg_connect(uintptr_t ptr, int64_t chatID, char *params,
                             bool isPresentation, ntg_async_struct future);

NTG_C_EXPORT int ntg_set_stream_sources(uintptr_t ptr, int64_t chatID,
                                        ntg_stream_mode_enum streamMode,
                                        ntg_media_description_struct desc,
                                        ntg_async_struct future);

NTG_C_EXPORT int ntg_pause(uintptr_t ptr, int64_t chatID,
                           ntg_async_struct future);

NTG_C_EXPORT int ntg_resume(uintptr_t ptr, int64_t chatID,
                            ntg_async_struct future);

NTG_C_EXPORT int ntg_mute(uintptr_t ptr, int64_t chatID,
                          ntg_async_struct future);

NTG_C_EXPORT int ntg_unmute(uintptr_t ptr, int64_t chatID,
                            ntg_async_struct future);

NTG_C_EXPORT int ntg_stop(uintptr_t ptr, int64_t chatID,
                          ntg_async_struct future);

NTG_C_EXPORT int ntg_time(uintptr_t ptr, int64_t chatID,
                          ntg_stream_mode_enum streamMode, int64_t *time,
                          ntg_async_struct future);

NTG_C_EXPORT int ntg_get_state(uintptr_t ptr, int64_t chatID,
                               ntg_media_state_struct *mediaState,
                               ntg_async_struct future);

NTG_C_EXPORT int ntg_send_external_frame(uintptr_t ptr, int64_t chatID,
                                         ntg_stream_device_enum device,
...
NTG_C_EXPORT int ntg_calls(uintptr_t ptr, ntg_call_info_struct *buffer,
                           uint64_t size, ntg_async_struct future);

NTG_C_EXPORT int ntg_calls_count(uintptr_t ptr, uint64_t *size,
                                 ntg_async_struct future);

NTG_C_EXPORT int ntg_on_stream_end(uintptr_t ptr, ntg_stream_callback callback,
                                   void *userData);

NTG_C_EXPORT int ntg_on_upgrade(uintptr_t ptr, ntg_upgrade_callback callback,
                                void *userData);

NTG_C_EXPORT int ntg_on_connection_change(uintptr_t ptr,
                                          ntg_connection_callback callback,
                                          void *userData);

NTG_C_EXPORT int ntg_on_signaling_data(uintptr_t ptr,
                                       ntg_signaling_callback callback,
                                       void *userData);

NTG_C_EXPORT int ntg_on_frames(uintptr_t ptr, ntg_frame_callback callback,
                               void *userData);

NTG_C_EXPORT int
ntg_on_remote_source_change(uintptr_t ptr, ntg_remote_source_callback callback,
                            void *userData);

NTG_C_EXPORT int ntg_get_version(char *buffer, int size);

NTG_C_EXPORT int ntg_cpu_usage(uintptr_t ptr, double *buffer,
                               ntg_async_struct future);
